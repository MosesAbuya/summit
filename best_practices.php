    ...
    <section class="section bg-white">
        <div class="container">
            <div class="section-header text-center">
                <h2>Featured Initiatives (2025-2026)</h2>
                <span class="african-divider-sm center"></span>
                <p class="subtitle mt-1" style="font-size: 1.1rem;">Discover how high-tier professional skills are actively bridging the socioeconomic divide.</p>
            </div>

            <div class="project-grid mt-4" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
                <!-- Project 1 -->
                <div class="project-card reveal-on-scroll" style="border: 1px solid #e2e8f0; border-radius: var(--border-radius-md); overflow: hidden; box-shadow: var(--box-shadow); transition: transform 0.3s; background: white; position: relative;">
                    <div style="position: relative; overflow: hidden;">
                        <img src="assets/past-summit/231201-135335.jpg" alt="Digital Inclusion" style="width: 100%; height: 200px; object-fit: cover;">
                ...
                <div class="project-card reveal-on-scroll" style="border: 1px solid #e2e8f0; border-radius: var(--border-radius-md); overflow: hidden; box-shadow: var(--box-shadow); transition: transform 0.3s; background: white; position: relative;">
                    <div style="position: relative; overflow: hidden;">
                        <img src="assets/past-summit/231201-101415.jpg" alt="University Clinics" style="width: 100%; height: 200px; object-fit: cover;">
                        <div style="position:absolute; top:0; left:0; right:0; height:5px; background-image: var(--pattern-kente-strip); background-size: 20px 5px;"></div>
                    </div>
                    <div style="padding: 1.5rem;">
                ...
                <div class="project-card reveal-on-scroll" style="border: 1px solid #e2e8f0; border-radius: var(--border-radius-md); overflow: hidden; box-shadow: var(--box-shadow); transition: transform 0.3s; background: white; position: relative;">
                    <div style="position: relative; overflow: hidden;">
                        <img src="assets/past-summit/231201-153912.jpg" alt="Red Cross Hub" style="width: 100%; height: 200px; object-fit: cover;">
                        <div style="position:absolute; top:0; left:0; right:0; height:5px; background-image: var(--pattern-kente-strip); background-size: 20px 5px;"></div>
                    </div>
                    <div style="padding: 1.5rem;">
                ...
                <div class="project-card reveal-on-scroll" style="border: 1px solid #e2e8f0; border-radius: var(--border-radius-md); overflow: hidden; box-shadow: var(--box-shadow); transition: transform 0.3s; background: white; position: relative;">
                    <div style="position: relative; overflow: hidden;">
                        <img src="assets/past-summit/231130-101322.jpg" alt="Global Corporate Benchmarks" style="width: 100%; height: 200px; object-fit: cover;">
                        <div style="position:absolute; top:0; left:0; right:0; height:5px; background-image: var(--pattern-kente-strip); background-size: 20px 5px;"></div>
                    </div>
                    <div style="padding: 1.5rem;">
            ...
            <div class="text-center" style="margin-top: 4rem;">
                <p style="margin-bottom: 1.5rem; font-size: 1.1rem;">Want to integrate your corporate team's skills into our next impact project?</p>
